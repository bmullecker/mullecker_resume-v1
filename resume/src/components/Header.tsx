...
export default function Header({ personalInfo }: { personalInfo: PersonalInfo }) {
    return (
        <header className="mb-4 print:mb-2 flex flex-col gap-1.5 print:gap-1">
            <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight uppercase print:text-3xl">
                {personalInfo.name}
            </h1>
            <h2 className="text-lg sm:text-xl font-bold text-gray-700 uppercase tracking-wide leading-tight print:text-lg">
                Senior UI/UX Architect & Developer
            </h2>
            <div className="text-[13px] sm:text-sm font-semibold text-gray-600 uppercase tracking-wide print:text-xs">
